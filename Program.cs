...
namespace Synthese_Image
{
    class Program
    {
        ...
        {
            Sphere s1 = new Sphere(new Vector3(500, 180, 210), 200, new Material(MaterialType.Diffuse, new Vector3(1, 0.05f, 0.05f)));
            Sphere s2 = new Sphere(new Vector3(200, 180, 74), 30, new Material(MaterialType.Diffuse, new Vector3(0.05f, 1, 0.05f)));
            Sphere s3 = new Sphere(new Vector3(200, 180, 550), 200, new Material(MaterialType.Diffuse, new Vector3(0.05f, 0.05f, 1)));
            Sphere s4 = new Sphere(new Vector3(30, 260, 30), 30, new Material(MaterialType.Diffuse, new Vector3(1, 1, 0.05f)));
